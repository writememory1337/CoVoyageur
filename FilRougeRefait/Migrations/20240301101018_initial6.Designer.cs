...
namespace CoVoyageur.API.Migrations
{
    ...
    [Migration("20240301101018_initial6")]
            ...
            modelBuilder.Entity("CoVoyageur.Core.Models.Ride", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = 1,
                            Arrival = "01/01/2025",
                            DateHour = new DateTime(2024, 3, 1, 11, 10, 17, 667, DateTimeKind.Local).AddTicks(8647),
                        ...
                        new
                        {
                            ID = 2,
                            Arrival = "02/01/2025",
                            DateHour = new DateTime(2024, 3, 1, 11, 10, 17, 668, DateTimeKind.Local).AddTicks(132),
            ...
            modelBuilder.Entity("CoVoyageur.Core.Models.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1,
                            BirthDate = new DateTime(2024, 3, 1, 11, 10, 17, 667, DateTimeKind.Local).AddTicks(5674),
                            DrivingLicense = true,
                            Email = "test1@test.com",
                            FirstName = "Leo",
                            InscriptionDate = new DateTime(2024, 3, 1, 11, 10, 17, 665, DateTimeKind.Local).AddTicks(4613),
                            IsAdmin = true,
                            LastName = "Dorat",
                        ...
                        {
                            ID = 2,
                            BirthDate = new DateTime(2024, 3, 1, 11, 10, 17, 667, DateTimeKind.Local).AddTicks(7230),
                            DrivingLicense = true,
                            Email = "test2@test.com",
                            FirstName = "Lea",
                            InscriptionDate = new DateTime(2024, 3, 1, 11, 10, 17, 667, DateTimeKind.Local).AddTicks(7217),
                            IsAdmin = false,
                            LastName = "Naconda",
                        ...
                        {
                            ID = 3,
                            BirthDate = new DateTime(2024, 3, 1, 11, 10, 17, 667, DateTimeKind.Local).AddTicks(7236),
                            DrivingLicense = true,
                            Email = "test3@test.com",
                            FirstName = "Leon",
                            InscriptionDate = new DateTime(2024, 3, 1, 11, 10, 17, 667, DateTimeKind.Local).AddTicks(7234),
                            IsAdmin = false,
                            LastName = "Sendort",
