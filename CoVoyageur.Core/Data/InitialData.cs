...
{
    new Ride { ID = 1, ID_Driver = users[0].ID, DateHour = DateTime.Now, Departure = "01/01/2025", Arrival = "01/01/2025", NbPlaces = 4, Price = 45 },
    new Ride { ID = 2, ID_Driver = users[1].ID, DateHour = DateTime.Now, Departure = "02/01/2025", Arrival = "02/01/2025", NbPlaces = 2, Price = 39 }
};
    }
}
